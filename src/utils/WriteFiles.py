...
class WriteFiles():
    ...
    def WriteResults(self, u_field, v_field, z_field, p_field, k_field, e_field, res_SIMPLE_ls, resx_momentum_ls, resy_momentum_ls, res_pressure, sim_time, resolution, iterations):
